...
\keywords{Computer science education, digital skills, programming, higher
  education, industry partnerships, UK}
...
sector, we also have a crucial enabling and facilitative horizonal
digital sector - in essence: there is no such thing as the `digital
economy' -- our economy is digital.
...
workforce is female~\cite{technation:2018}. Indeed, the Institute of Coding announcement \cite{DfE2018a} quoted the even more pessimistic ``In 2017, female programmers and software developers made up just 3.9 per cent of tech and telco professionals in the UK''.
...
shortages. While there is a strong socio-economic policy focus, it
should not just be about jobs: we want, and need, a digitally
competent, capable and engaged citizenry. But what do we mean by
...
least three recent House of Commons and House of Lords Select
Committee inquiries~\cite{ukholds:2015,ukhocst:2016,ukholc:2017} have,
wholly or in part, focused on the `digital skills crisis'. They have
made a number of specific recommendations, from curriculum and
qualifications reform, improving professional learning for
practitioners, investment in infrastructure, developing effective
pedagogies and the wider educational research base in the UK, through
to terminology, fixing `leaky pipelines' and changing wider public
...
emerging reform in
Wales~\cite{crick+moller:wipsce2015,moller+crick:jce2018}, we have
also seen significant changes to the available qualifications, based
on perceived rigour, content, distinctiveness and modes of
...
as possible when referring to specific interventions in the four nations.
...
\section{UK Higher Education Policy Context}
...
seeking to hire people wih ``10 years experience of programming in
...
\item ``Widening participation''. This is aimed at the problems identified in \S\ref{sec:Gender}.
...
The Institute of Coding is very much ``work in progress'': at the time of writing it was just over six months old.  The mere adumbration \cite{HMG2015a} prompted the research in \cite{murphy-et-al:programming2017}, and the various working groups round the themes are causing more discussion of computing pedagogy in the UK than the authors can ever remember.
