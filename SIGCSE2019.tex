...
Institute of Coding, its key themes and preliminary activities, as
well as reflecting on potential replicability of aspects of the
Institute to other jurisdictions with similar ambitions.
...
conclusions, future work and the potential replicability of aspects of
...
It is explicitly an industry--university collaboration, with the Government contributing at most 50\% of the money.
 It is structured around five themes.
\begin{enumerate}
\item ``University learners''. This is aimed at understanding, and solving, the ``Skills Mismatch'' problems (see \S\ref{sec:Skills}). As seen from \S\ref{sec:Code}, these problems can be qute subtle, and are not addressed by such broad requirements as \cite[Requirement 2.3.1]{BCS2018a}.
...
Foundation, et al.), providing a platform for conducting research
