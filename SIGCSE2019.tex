...
\begin{document}
\title{The Institute of Coding: A Model for University-Industry
  Collaboration to Address the UK Digital Skills Crisis}
%\titlenote{}
...
%Overall framing for the paper, etc? <-- should this be earlier to set
%the scene and link to the national/international edu/skills context?
...
to be the more self-motivated ones, who woul dprobably do well
