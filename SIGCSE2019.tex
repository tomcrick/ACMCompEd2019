...
\begin{document}
\title{The Institute of Coding: A UK Uniiversity--Industry
...
\begin{abstract}
The Institute of Coding is a new initiative by the U.K. Government to transform the digital skills profile of the country.  It responds to the apparently contradictory data that the country has a digital skills shortage yet unemployed computing graduates. This initiative needs to balance education versus training, ``industry-readiness'' versus ``deep education'', technical skills versus soft skills. All this is taking place in the higher education/work force area at the same time as radical changes are taking place in the school curriculum, with all children expected to learn two programming languages. 

We describe the background and evidence base for the Institute, its hybrid structure and planned deliverables.
% abstract to be started by Tom
\end{abstract}
