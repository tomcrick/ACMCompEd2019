...
Degree Apprenticeships can be either ``Level 6'' (BSc. level) or ``Level 7'' (MSc. level''). The level 6 ones last 3--5 years, typically 4. One such is detailed at \url{http://www.aston.ac.uk/study/degree-apprenticeships/employers/degree-apprenticeship-programmes/digital-and-technology-solutions-degree-apprenticeship/}. The Goverment has just (7 August 2018) approved the details of level 7 ones \cite{IfA2018a}, so not much can be said.
