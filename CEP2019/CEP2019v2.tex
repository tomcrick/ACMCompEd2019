...
\email{{a.hayes,r.hourizi}@bath.ac.uk}
...
%the impact of digital on all of our lives is clear. 
...
however, that Computing is 20\% of STEM, %\cite[Table
...
% \footnote{STEM is ``Science, Technology, Engineering,
% Mathematics'' for \cite{Shadbolt2016a} and this paper.}
...
\section{UK University Policy Context}\label{ukhepolicy}
...
study. This is remarkably successful in computing.  %The University of
...
%\footnote{And at least anecdotal evidence elsewhere: ``the co-op system is a major reason for our [University of Waterloo] success'' \cite{Watt2017a}.}:
...
\noindent{\textbf{University Learners:}} This is aimed at understanding, and
solving, the ``Skills Mismatch'' problems (see \S\ref{sec:Skills}).
%As seen from \S\ref{sec:Code}, % commented out as section commented
out.  These problems can be qute subtle, and are not addressed by such
...
\noindent{\textbf{The Digital Workforce:}} In practice this is largely aimed at
...
\noindent{\textbf{Digitalising the Professions:}} The official description ``to
...
\noindent{\textbf{Widening Participation:}} This is aimed at the problems
...
\noindent{\textbf{Knowledge Sharing and Sustainability:}} A perverse, but totally
