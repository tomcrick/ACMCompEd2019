...
In this paper, we outline the background, evidence base and rationale
...
\begin{IEEEkeywords}
Digital skills, Software engineering, Programming, Undergraduate
education, Graduate education, Computer science education, Industry collaboration
\end{IEEEkeywords}
...
We are frequently informed that this is ``the digital age'', and that
we ``live in a knowledge economy''\footnote{Despite the debunking by
Friesen~\cite{Friesen2008}.}, with ``software eating the
world''~\cite{andreessen:2011}; nevertheless, the impact of digital on
all of our lives is clear. From entertainment and interactions, via
the power and reach of an oligopoly of social media platforms, with
opaque algorithms influencing what news we consume, or making
decisions that affect us every day; to education, health and social
care, through to fostering innovation in essential public
services~\cite{ecdsmsuk:2018}. We are also seeing the emergence of
``big data'', machine learning and artificial intelligence as
general-purpose technologies that could transform whole industries and
may even re-invent the process of invention
...
There are a wide range of initiatives around the world to address the
digital skills shortages or today~\cite{cece:2017}. While this is
often pushed on economic grounds, there are social needs: every
country needs a digitally-confident and capable citizenry. The basic
case is made in \cite{davenport-et-al:cep2019}; at least three recent
UK Parliamentary Select Committee
inquiries~\cite{ukholds:2015,ukhocst:2016,ukholc:2017} have, wholly or
in part, focused on the `digital skills crisis'. This is alongside
...
We have also seen significant changes to the available technical
qualifications in this domain, based on perceived rigour, content,
distinctiveness and modes of assessment; again, this work is described
in more detail in \cite{davenport-et-al:cep2019}.

Furthermore, the disruption from the ongoing COVID-19/novel
coronavirus global pandemic and the social isolation it is
engendering, is impacting essentially all organisations and structures
-- from all levels of the education
system~\cite{watermeyer-et-al:2020}, the ``Mother of Parliaments'' (UK
Parliament), to Alcoholics Anonymous meetings -- dragging them into
the digital age. This has made the heterogenous distribution of
digital skills and digital provision in society starkly obvious.
...
England and Wales in the case of the Institute fo Coding itself), as a
number of policy areas, including education and skills, are devolved
to the respective national governments. We will attempt to be as clear
...
qualifications~\cite[Figure 4]{BIS2011a}, ``mathematical and computer
sciences'' have the second highest earnings return of all subjects
(overtaken only by ``medicine and dentistry'').  The country profits
from this as well: per head, it is the fourth most beneficial subject
to the UK~\cite[p.~16]{BIS2011a} (and backed up by the detailed
analysis in \cite[Figure 15]{DfE2018d}, \emph{provided} one adjusts
for prior attainment and background). Nevertheless, despite the
...
the discrepancy between skills shortage and apparently relevant
graduate unemployment was highlighted in the 2016 UK Government's
``Shadbolt'' review~\cite{Shadbolt2016a}. This, and the discrepancies
in graduate outcomes, is addressed in \cite[\S
IIA]{davenport-et-al:cep2019}. The brief summary is that, after
allowing for socio-economic factors, which the headline new graduate
unemployment figures (11.7\% versus a `` Science, Technology,
Engineering and Mathematic'' (STEM) average of 8.4\%) that
prompted the review, computing did not have a worse employment
position than other subjects, but also does not have the superior employment
record that one might expect.
...
The UK's graduate longitudinal education outcomes (LEO)
dataset~\cite{DfE2017a} tracks individuals from school via university
to jobs (or at least taxpayers), and can therefore answer questions
such as ``allowing for prior school attainment and other background
features, how much does studying {\emph{subject X}} at {\emph{university Y}} affect
earnings?''.  Of course, earnings are not the same as quality of life, or
contribution to society, but they are measurable (see detailed
analysis~\cite[\S IIB, IIC]{davenport-et-al:cep2019}).
...
underpinning the official UK Government figures~\cite{DfE2018d},
resulting in challenging figures for Computing. Salary premiums,
allowing for the factors described in\cite[\S
IIB]{davenport-et-al:cep2019}, are reported separately for men and
women, and only if there were at least 50 students of that gender in
the five cohorts (graduation cohort 2007--8 to graduation cohort
2011--12) considered. This means that, of the 82 English universities
reporting Computing, 80 report male data and 30 report female data --
28 report both. Looking at the 28 (see Figure \ref{fig:BBC}), one's
first impression is that the male and female data are uncorrelated:
for example the two universities with male premiums just above
+\pounds2500 have female premiums of +\pounds9325 and
-\pounds5793. There is in fact a definite ($p=0.0034$) positive
correlation, but a fairly weak one ($R^2=0.286$). The best fit is
$W=0.92672+0.53388*M$. Since average graduate earnings are
\pounds30,000/year for men and \pounds26,000/year for women
\cite[p. 37]{DfE2018d} the ideal ``gender-neural'' fit would be
...
students are not ``industry-ready'', or there is a ``skills
mismatch'', or that they do not demonstrate a long list ``work-ready
skills'', including grit and
resilience~\cite{prickett-et-al:iticse2020}. Some of this is due to a
misapprehension on the part of employers -- and perhaps
misunderstanding of the nature of (technical) education versus
training (for example, exhibited by those outside the ICT industry
itself, but seeking to hire people with ``10 years experience of
programming in Ruby''), but much of it is genuine. Previous work in
...
exercise, now called the Research Evaluation Framework
...
time of writing~\cite{IfA2018a}, so it is hard to determine how they
will work in practice. However, the entire Degree Apprenticeship
mechanism does seem to be geared more to large companies capable of
supporting a bespoke programme, as for example is happening in
Accountancy, where the ``Big Four'' firms are enthusiastically
supporting such programmes\footnote{For example:
...
sandwich degrees, but this has numerous challenges: the supply of
employers willing to offer such placements is limited, and often they
are only offered to a limited number of universities with whom the
employer has built up relations, often going back decades; the
university needs to invest in the process: a successful sandwich year
programme is not a matter of simply allowing students to intermit
their studies; and finally, some students do not wish to, often for
valid personal or financial reasons.
...
student. However, it is the second class that we are investigating
in the hope that non-sandwich courses can learn from them. There is sharing of experience within the Institute, but it currently appears that several models have emerged, all of which work significantly better than doing nothing, but it is hard to compare them.
...
to train and work in digital. We have sampled three cohorts: working
people, university learners and 15-18s. The focus is primarily on the
gender difference, and different aspects within the female cohort. The full results are being written up\footnote{To appear in the Instotute's repository: \url{https://instituteofcoding.org/the-repository/}.}, but the headline observation is that there are three main obstacles:
\begin{enumerate}
\item the perception of the industry;
\item the lack of clear signposting in terms of education and careers;
\item the lack of visibly tailored and flexible learning.
\end{enumerate}
The Institute of Coding, especially Theme 3, is partly addressing the third problem, and is working with its industry partners on the first. The second is a tough problem, as schools careers advice is outside the funded remit of both the Institute of Coding and the National Centre for Computing Education.
...
Hence the Institute of Coding has organised sessions at the 2019 and
2020 instantiations of the new (first instantiation 2017) UK-specific
ACM Conference on Computing Education
Practice~\cite{CEP2019,CEP2020}.  The papers here, and other
Institute of Coding publications, are indexed in the IoC repository:
\url{https://instituteofcoding.org/the-repository/}.

\cite{CortesRiosetal2019b} responds to a common industry complaint that ``students don't learn \emph{real} software engineering'' (which often means ``don't learn how to use specific tools'') by exploring the teaching of GitLab, and how the authors can use the students' use of GitLab to find patterns and evaluation metrics that can
be used to improve the course content.
...
other jurisdictions. We have seen a number of challenges in the recruitment and
retention of pre-university practitioners (especially in
...
time, but the process itself was not cut.} the often labyrinthine ``quality assurance'' processes in
...
in 2018/19 and 16 (so far) in 2019/20.  There has been an additonal effect: some universities, for whom IoC was their introduction to Degree Apprenticeships, are now running others.  %Bath/Architecture
...
courses. Of the almost 200,000 learners enrolled (as at the end of March
2020) on IoC courses, vast majority are enrolled on these.  The IoC has
...
post-compulsory); furthermore, this fits with the wider aspiration of
developing broader and transferable societal digital, data and
computational skills. There is a long history in the UK and
...
by impactful work on developing digital skills by Nesta, the UK's
innovation
...
School (CAS), Technocamps, Raspberry Pi Foundation, Code Club, {\it et
...
skills. Whilst it is clear these goals will not be fully achieved in
