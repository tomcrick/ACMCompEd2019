...
%In this paper, w
We describe the background and evidence base for the
...
%,  UK}   %JHD True, but is it worth a line?
  }
...
challenging.
%; the OECD's 2002 definition of the ICT sector does not provide much insight: ``{\emph{...a combination of manufacturing and services industries that capture, transmit and display data and information electronically}}''~\cite{oecd:2002}. 
