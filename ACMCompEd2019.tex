...
that we ``live in a knowledge economy''\footnote{Despite the debunkingin \cite{Friesen2008}.}
...
challenging; the OECD's 2002 definition of the ICT sector does not provide much insight: ``{\emph{...a combination of manufacturing and services industries that capture, transmit and display data and information electronically}}''~\cite{oecd:2002}. 
...
Wales~\cite{moller+crick:jce2018},
...
skills. 
%When establishing a model for viewing school computer science education, it is apparent that there is substantial diversity between education systems, and this can create obstacles when trying to understand progress made in one country and potentially replicate it in another~\cite{hubwieser:2013}; this is particularly relevant to the devolved (and diverging) educational systems of the UK, as well as the  variety of its disparate interventions. 
...
universities, colleges, employers including but not limited to industry, local and national government, as
...
% Introducing the IoC as an effective % educational/industrial collaborative intervention? 
% JHD: yes indeed
% Recognising all  of the mistakes/missed opportunities from before, even though
% JHD: again parochial?
