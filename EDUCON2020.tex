...
2015~\cite{HMG2015a}, the {\emph{Institute of Coding}} (IoC)\footnote{\url{https://instituteofcoding.org}} is one of the UK
Government's latest responses to the ``digital skills
challenge''~\cite{davenport-et-al:cep2019}. The IoC brings
...
Whilst the {\emph{Institute of Coding}} is still very much an ongoing ``work in
...
MOOCs (e.g. Elements of AI, a series of free online courses created by
the University of
