...
``deep education'', and managing expectations for the diverse digital,
...
context); its key themes, current activities and outputs; as well as anticipate
its likely impact over the coming years. Furthermore, we reflect on
the potential replicability of aspects of the Institute (and related
initiatives in the UK) to other nations or regions with similar
ambitions to address the ``digital skills crisis''.
\end{abstract}
...
Our current activity is a survey to understand the motivating factors for why different groups of people choose (or not) to train and work in digital. We are sampling three cohorts: working people, university learners and 15-18s. The focus is primarily on the gender difference, and different aspects within the female cohort. 
...
many years elsewhere~\cite{simon-et-al:sigcse2018}. This has also prompted a renewed look at how professional accreditation can help disseminate good practice \cite{crick-et-al:cep2020}.
...
is devoted to ``educating the educators''.
...
(undergraduate/BSc) course or degree apprenticeship. Hence the Institute needs
...
of writing it is slightly less than two years on from the official launch
...
\begin{table}
\caption{IoC Learners to date\label{tab:data}}
\begin{tabular}{lrr}
&Courses&Learners\\
	BSc. etc.&5&493\\
